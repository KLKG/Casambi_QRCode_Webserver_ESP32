...
void website_index(){
    ...
    strcat(webpage_new, String("<div class=\"divider-custom-icon\"><i class=\"fas fa-qrcode\"></i></div>\n").c_str());    
    strcat(webpage_new, String("<div class=\"divider-custom-line\"></div>\n").c_str());    
    strcat(webpage_new, String("</div>\n").c_str());    
    strcat(webpage_new, String("<p class=\"startscreen-subheading font-weight-light mb-0\">Casambi QR-Code</p>\n").c_str());    
